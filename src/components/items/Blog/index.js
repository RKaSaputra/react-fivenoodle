          ...
          <div class="post-container">
            <div className="post-content-container">
              <div className="post thumb">
                <img className="post-img" src={img1} alt="Asinan Kelengkeng" />
              </div>
            ...
            <div className="post-content-container">
              ...
              <div className="post-details">
                <a className="post link" href="#">
                  <h4 className="post title">[RECIPE] KOREAN MAYO EGG TOAST</h4>
                </a>
              </div>
              <p className="post paragraph">
            ...
            <div className="post-content-container">
              <div className="post thumb">
                <img className="post-img" src={img4} alt="Asinan Kelengkeng" />
              </div>
              <div className="post-details">
                <a className="post link" href="#">
